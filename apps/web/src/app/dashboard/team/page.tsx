    ...
    return (
        <div className="space-y-6 animate-fade-in relative">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div className="relative flex-1 max-w-md">
                    ...
                    <input
                        ...
                        className="pl-9 pr-4 py-2 w-full text-sm border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 shadow-sm"
                        value={searchTerm}
            ...
            <Card className="overflow-hidden">
                                ...
                                <tr key={member.id} className="hover:bg-slate-50/50 transition-colors">
                                    <td className="px-6 py-4">
                                        <div className="flex items-center gap-3">
                                            <div className="w-9 h-9 rounded-full bg-teal-50 border border-teal-100 text-teal-700 flex items-center justify-center font-bold text-xs">
                                                {member.avatar}
                                            </div>
                                            <div>
                ...
                <div className="p-4 border-t border-slate-50 bg-slate-50/30 text-xs text-slate-500 flex justify-between items-center">
                    ...
                    <div className="bg-white rounded-xl shadow-xl border border-slate-200 w-full max-w-md p-6">
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <input type="email" placeholder="colleague@stmarys.org" className="w-full p-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:outline-none" />
                            </div>
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-1 gap-2">
                                    {['Admin', 'Supervisor', 'Agent', 'Read-only'].map((role) => (
                                        <label key={role} className="flex items-center p-3 border border-slate-200 rounded-lg cursor-pointer hover:border-teal-500 hover:bg-teal-50/30 transition-all">
                                            <input type="radio" name="role" className="text-teal-600 focus:ring-teal-500" />
