      ...
      <main>
        <section className="mx-auto max-w-3xl px-6 pt-20 pb-12 text-center lg:px-12">
          ...
          <p className="mt-6 text-lg text-muted-foreground">
            Questions about Wardline, pricing, or a demo for your clinic—we&apos;ll respond as soon
            as we can.
          </p>
        </section>
        ...
        <section className="mx-auto max-w-6xl px-6 pb-24 lg:px-12">
          <div className="grid gap-12 lg:grid-cols-2">
            <div className="rounded-3xl bg-[var(--background)] p-8 neo-raised lg:p-10">
              ...
              {submitted && (
                <div className="mt-6 rounded-2xl bg-emerald-500/10 px-4 py-3 text-sm font-medium text-emerald-700 neo-inset">
